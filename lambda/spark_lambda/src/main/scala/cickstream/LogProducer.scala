...
//Extend is used so that we do not have to specify main
object LogProducer extends App {
  // WebLog config is used to load the resource file
  val wlc = Settings.WebLogGen

  //Transferred into lines and then array of strings
  ...
  val filePath ="C:\\Boxes\\spark-kafka-cassandra-applying-lambda-architecture\\vagrant\\data.tsv"
